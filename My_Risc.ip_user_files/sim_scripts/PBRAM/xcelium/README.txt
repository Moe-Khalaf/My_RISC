...
#
# Generated by export_simulation on Sat Dec 21 17:09:30 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './PBRAM.sh' script.
...
./PBRAM.sh -noclean_files

For more information on the script, please type './PBRAM.sh -help'.
